...
public class TimeIntervalSum {
     public static void main(String[] args) {
        ...
        // Get the first time interval from the user
        ...
        // Get the second time interval from the user
        ...
        // Calculate the sum of the two time intervals
    ...
    // Helper class to store time interval
